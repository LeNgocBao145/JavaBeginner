...
public class TicketList {
	...
	public TicketList(ArrayList<Ticket> _listTicket) {
		this.listTicket = _listTicket;
	}
	...
	void LapPhieuMuon(Reader* x, Book* y, Ticket* z, int &n, int j, int quantity, string daynow, fstream& phieu, fstream& sach)
	{
		...
		int S = 0;
			...
			system("cls");
			System.out.println( "========================================================================================================================================================================\n";
			System.out.println( "|Ma    |" << setw(18) << left << "Ho va Ten" << setw(16) << left << "|CMND/CCCD" << setw(13) << left << "|Ngay sinh" << setw(12) << left << "|Gioi tinh" << setw(27) << left << "|Email" << setw(44) << left << "|Dia chi" << setw(16) << left << "|Ngay lap the" << setw(10) << left << "|Ngay het han" << "|" << endl;
			System.out.println( "|" << setw(6) << "______" << "|" << setw(18) << "__________________" << "|" << setw(15) << "_______________" << "|" << setw(12) << "____________" << "|" << setw(11) << "___________" << "|" << setw(22) << "__________________________" << "|" << setw(43) << "___________________________________________" << "|" << setw(15) << "_______________" << "|" << setw(12) << "____________" << "|" << endl;
			for (int i = 0; i < j; i++) {
				System.out.println( "|" << setw(6) << left << x[i].code << "|" << setw(18) << left << x[i].ho_ten << "|" << setw(15) << left << x[i].cccd << "|" << setw(12) << left << x[i].ngay_sinh << "|" << setw(11) << left << x[i].gioi_tinh << "|" << setw(26) << left << x[i].email << "|" << setw(43) << left << x[i].dia_chi << "|" << setw(15) << left << x[i].ngay_lap_the << "|" << setw(12) << left << x[i].ngay_het_han << "|" << endl;
				System.out.println( "|" << setw(6) << "______" << "|" << setw(18) << "__________________" << "|" << setw(15) << "_______________" << "|" << setw(12) << "____________" << "|" << setw(11) << "___________" << "|" << setw(22) << "__________________________" << "|" << setw(43) << "___________________________________________" << "|" << setw(15) << "_______________" << "|" << setw(12) << "____________" << "|" << endl;
			}
			System.out.println( "========================================================================================================================================================================\n" << endl;
			...
			for (int i = 0; i < quantity; i++) {
				System.out.println( "|" << setw(6) << left << y[i].ISBN << "|" << setw(39) << left << y[i].ten_sach << "|" << setw(27) << left << y[i].tac_gia << "|" << setw(27) << left << y[i].nha_xuat_ban << "|" << setw(12) << left << y[i].nam_xuat_ban << "|" << setw(24) << left << y[i].the_loai << "|" << setw(14) << left << fixed << setprecision(3) << (y[i].gia_tien) << "|" << setw(9) << left << y[i].so_luong << endl;
				System.out.println( "|" << setw(6) << "______" << "|" << setw(39) << "_______________________________________" << "|" << setw(27) << "___________________________" << "|" << setw(27) << "___________________________" << "|" << setw(12) << "____________" << "|" << setw(23) << "________________________" << "|" << setw(14) << "______________" << "|" << setw(9) << "___________" << endl;
			}
			System.out.println( "========================================================================================================================================================================\n" << endl;

			System.out.println( "Nhap so luong sach ma ban muon muon (toi da 5 cuon): ";
			cin >> z[n - 1].SLmuon;
	...
	void LapPhieuTra(Book* y, Ticket* z, int n, int j, string daynow, fstream& phieu, fstream& sach)
	{
		...
		InPhieuMuonTra(z, n);
			...
			System.out.println( "Ban vui long nhap ma phieu muon: ";
			cin >> ma;
			while (codeInListMaPhieu(ma, n, z) == false)
			{
				System.out.println( "Khong the tim thay ma phieu muon. Xin vui long nhap lai!" << endl;
				int choose;
				System.out.println( "1. Nhap lai ma phieu muon" << endl;
				System.out.println( "2. Thoat" << endl;
				System.out.println( "\nNhap lua chon: ";
				cin >> choose;
				switch (choose)
			...
			for (int i = 0; i < n; i++)
			{
				...
				if (ma == z[i].MaPhieu)
				{
					...
					System.out.println( "|" << setw(8) << left << "Ma phieu" << "|" << setw(9) << left << "Ma doc gia" << "|" << setw(14) << left << "Ngay muon" << "|" << setw(18) << left << "Ngay tra du kien" << "|" << setw(18) << left << "Ngay tra thuc te" << "|" << setw(8) << left << "SL muon" << "|" << setw(31) << left << "Danh sach ISBN sach duoc muon" << "|" << setw(7) << left << "SL mat" << "|" << setw(28) << left << "Danh sach ISBN sach bi mat" << "|" << setw(14) << left << "Tong tien phat" << "|" << endl;
					System.out.println( "|" << setw(8) << "________" << "|" << setw(9) << "__________" << "|" << setw(14) << "______________" << "|" << setw(18) << "__________________" << "|" << setw(18) << "__________________" << "|" << setw(8) << "________" << "|" << setw(26) << "_______________________________" << "|" << setw(7) << "_______" << "|" << setw(27) << "____________________________" << "|" << setw(14) << "______________" << "|" << endl;
					System.out.println( "|" << setw(8) << left << z[i].MaPhieu << "|" << setw(10) << left << z[i].codeDGMuon << "|" << setw(14) << left << z[i].borrowDate << "|" << setw(18) << left << z[i].expectPayDate << "|" << setw(18) << left << " " << "|" << setw(8) << left << z[i].SLmuon << "|";
					for (int a = 0; a < z[i].SLmuon; a++)
					{
						System.out.println( left << z[i].codeSachMuon[a] << " ";
					}
					switch (z[i].SLmuon)
					{
					case 1:
						System.out.println( setw(27);
						break;
					case 2:
						System.out.println( setw(22);
						break;
					case 3:
						System.out.println( setw(17);
						break;
					case 4:
						System.out.println( setw(12);
						break;
					case 5:
						System.out.println( setw(7);
						break;
					}
					System.out.println( right << "|" << setw(7) << left << z[i].SLmat << "|" << setw(28) << left << " " << "|" << setw(14) << left << z[i].TongTienPhat << "|" << endl;
					System.out.println( "|" << setw(8) << "________" << "|" << setw(9) << "__________" << "|" << setw(14) << "______________" << "|" << setw(18) << "__________________" << "|" << setw(18) << "__________________" << "|" << setw(8) << "________" << "|" << setw(26) << "_______________________________" << "|" << setw(7) << "_______" << "|" << setw(27) << "____________________________" << "|" << setw(14) << "______________" << "|" << endl;
					System.out.println( "=======================================================================================================================================================================" << endl;



					System.out.println( "So sach bi mat ";
					cin >> z[i].SLmat;
					...
					if (Distance2Date(z[i].expectPayDate, z[i].actualPayDate) > 7)
					{
						...
						System.out.println( "Sach tre han " << Distance2Date(z[i].expectPayDate, z[i].actualPayDate) << " ngay" << endl;
					}
					else
					{
						System.out.println( "Sach khong tre han" << endl;
						z[i].TongTienPhat = 0;
					}
					...
					for (int i = 0; i < n; i++)
					{
						...
						if (ma == z[i].MaPhieu)
						{
							for (int h = 0; h < z[i].SLmat; h++)
							{
								...
								{
									System.out.println( "Khong the tim thay ma ISBN cua sach trong danh sach muon" << endl;
									System.out.println( "\nNhap ma ISBN cua sach mat ";
									cin >> z[i].codeSachMat[h];
								}
								...
								for (int b = 0; b < j; b++)
								{
									...
									if (y[b].ISBN == z[i].codeSachMat[h])
									{
										...
										System.out.println( "Gia tien: " << y[b].gia_tien << endl;
										break;
									}
								}
	...
	{
		system("cls");
		System.out.println( "<<===========================================================DANH SACH PHIEU MUON TRA SACH CUA DOC GIA===============================================================>>\n";
		...
		for (int i = 0; i < n; i++)
		{
			...
			System.out.println( "|" << setw(8) << left << z[i].MaPhieu << "|" << setw(10) << left << z[i].codeDGMuon << "|" << setw(14) << left << z[i].borrowDate << "|" << setw(18) << left << z[i].expectPayDate << "|" << setw(18) << left << z[i].actualPayDate << "|" << setw(8) << left << z[i].SLmuon << "|";
			for (int j = 0; j < z[i].SLmuon; j++)
			{
				System.out.println( left << z[i].codeSachMuon[j] << " ";

			}
			switch (z[i].SLmuon)
			{
			case 0:
				System.out.println( setw(29);
				break;
			case 1:
				System.out.println( setw(27);
				break;
			...
			System.out.println( right << "|" << setw(7) << left << z[i].SLmat << "|";
			for (int h = 0; h < z[i].SLmat; h++)
			{
				System.out.println( left << z[i].codeSachMat[h] << " ";
			...
			case 0:
				...
				break;
			case 1:
				System.out.println( setw(24);
				break;
			case 2:
				System.out.println( setw(19);
				break;
			case 3:
				System.out.println( setw(14);
				break;
			case 4:
				System.out.println( setw(9);
				break;
			case 5:
				System.out.println( setw(4);
				break;
			}
			System.out.println( right << "|" << setw(14) << left << z[i].TongTienPhat << "|" << endl;
			System.out.println( "|" << setw(8) << "________" << "|" << setw(9) << "__________" << "|" << setw(14) << "______________" << "|" << setw(18) << "__________________" << "|" << setw(18) << "__________________" << "|" << setw(8) << "________" << "|" << setw(26) << "_______________________________" << "|" << setw(7) << "_______" << "|" << setw(27) << "____________________________" << "|" << setw(14) << "______________" << "|" << endl;
